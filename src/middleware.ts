...
export const config = {
  ...
  // the public PWA icon/manifest routes (the OS fetches those without a session).
  matcher: [
    "/((?!api/auth|_next/static|_next/image|favicon.ico|icon|apple-icon|manifest.webmanifest|.*\\..*).*)",
  ],
};
